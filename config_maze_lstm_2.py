...
root = "./results"
directory = root + "/workspace_maze21x21_lstm_2/"
directory_load = root + "/workspace_maze9x9_lstm_2/"
...
model = ModelLSTMBase1(input_shape=(15,), output_shape=(5,), hidden_size=64, extra_hidden_size=64, output_activation="none", initialize_settings='R', init_scale=0.05, initialize_hyper_parameter=0.50)
...
load_model = directory_load + "/models/model.011000.dat"
...
test_load_model = root + "/workspace_maze9x9_lstm_2/models/model.015000.dat"
