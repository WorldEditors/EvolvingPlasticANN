...
root = "./results"
directory = root + "/workspace_maze_l_decprnn/"
...
load_model = root + "demo/models/model.maze15_lstm.dat"
...
inner_rollouts = [(0.0, "TRAIN", True), (0.0, "TRAIN", True), (0.0, "TRAIN", True),
        (0.1, "TEST", True), (0.2, "TEST", True), (0.3, "TEST", True),
        (0.4, "TEST", True), (0.6, "TEST", True), (0.8, "TEST", True)
        ]
