...
root = "./results"
directory = root + "/workspace_maze_l_decprnn_large/"
...
#model = ModelPRNNNoMod(input_shape=(15,), output_shape=(5,), hidden_size=128, output_activation="none", initialize_settings='R', hebbian_type=3, init_scale=0.05)
...
model = ModelPRNNAfterMod(input_shape=(15,), output_shape=(5,), hidden_size=128, output_activation="none", initialize_settings='R', hebbian_type=3, init_scale=0.05)

# Refer to config_SeqPred_task.py for other configurations

#If no load_model is specified, the model is random initialized
#load_model = "./models/maze21_l_decprnn.dat"
load_model = directory + "models/model.003000.dat"
...
inner_rollouts = [(0.0, "TRAIN", True), (0.0, "TRAIN", True), (0.0, "TRAIN", True),
	(0.0, "TRAIN", True), (0.0, "TRAIN", True), (0.0, "TRAIN", True),
	(0.0, "TRAIN", True), (0.12, "TEST", True), (0.16, "TEST", True),
