...
root = "./results"
directory = root + "/workspace_loco_lstm/"
...
model = ModelLSTMBase1(input_shape=(38,), output_shape=(8,), hidden_size=64, extra_hidden_size=64, output_activation="none", initialize_settings='R', init_scale=0.05)
...
load_model = root + "/workspace_loco_lstm/models/model.015000.dat"
...
inner_rollouts = [(0.0, "TEST", True), (0.6, "TEST", True), (1.0, "TEST", True)]
