...
root = "./results"
directory = root + "/workspace_maze21x21_prnn_postdn_1/"
directory_load = root + "/workspace_maze21x21_prnn_postdn_1/"
...
load_model = directory_load + "/models/model.013000.dat"
