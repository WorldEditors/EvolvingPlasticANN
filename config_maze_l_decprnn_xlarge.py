...
root = "./results"
directory = root + "/workspace_maze_l_decprnn_xlarge/"
...
#model = ModelPRNNNoMod(input_shape=(15,), output_shape=(5,), hidden_size=256, output_activation="none", initialize_settings='R', hebbian_type=3, init_scale=0.05)
...
model = ModelPRNNAfterMod(input_shape=(15,), output_shape=(5,), hidden_size=256, output_activation="none", initialize_settings='R', hebbian_type=3, init_scale=0.05)
